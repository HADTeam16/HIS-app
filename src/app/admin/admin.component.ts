...
export class AdminComponent {
    ...
    doctorDataSource = new MatTableDataSource<PeriodicElement>(
        DOCTOR_ELEMENT_DATA
    );
    receptionistDataSource = new MatTableDataSource<PeriodicElement>(
        RECEPTIONIST_ELEMENT_DATA
    );
    nurseDataSource = new MatTableDataSource<PeriodicElement>(
        NURSE_ELEMENT_DATA
    );
